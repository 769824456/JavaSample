package java基础.注解.annotations2;

import java.lang.reflect.Constructor;
import java.lang.reflect.Field;


@MyAnnotation.MyClassAnnotation(desc = "The class", uri = "com.test.java基础.注解.annotation.Test")
@MyAnnotation.Yts(classType = MyAnnotation.Yts.YtsType.util)
public class TestAnnotation {
    @MyAnnotation.MyFieldAnnotation(desc = "The class field", uri = "com.test.java基础.注解.annotation.Test#id")
    private String id;

    @MyAnnotation.MyConstructorAnnotation(desc = "The class constructor", uri = "com.test.java基础.注解.annotation.Test#MySample")
    ...
    @MyAnnotation.MyMethodAnnotation(desc = "The class method", uri = "com.test.java基础.注解.annotation.Test#setId")
    public void setId(String id) {
        System.out.println(" method info: " + id);
        this.id = id;
    }

    @MyAnnotation.MyMethodAnnotation(desc = "The class method sayHello", uri = "com.test.java基础.注解.annotation.Test#sayHello")
    @MyAnnotation.Yts
